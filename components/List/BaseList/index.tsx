...
const BaseList = <T,>(props: ListProps<T>) => {
    const {
        data,
    ...
    const [ListComponent, componentProps]: [React.ElementType, Record<string, unknown>] = useMemo(() => {
        if (Component === React.Fragment) {
            const hasComponentProps = className || _ref || style || onEndReached;
    ...
    }, [Component, className, ref, style, handleItemScroll, _ref, onEndReached]);
